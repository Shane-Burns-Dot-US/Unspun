...
yaml_doc={'meta':{'version':VER,'atoms':len(ledger),'dispositions':dict(dispc),
...
rows=[f'# Merge Map · v{VER} — all 78 atoms retained, each mapped to Unspun',
 '',
...
ug={'meta':{'version':VER,'note':'Unified projection: Unspun KG + all 78 Fête atoms + outcomes, joined on atom_code.',
...
json.dump({'meta':{'version':VER,'atoms':len(ledger),'targets':len(tset),
